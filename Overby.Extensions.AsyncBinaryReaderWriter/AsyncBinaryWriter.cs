...
#pragma warning restore 169
        ...
        // 
        public virtual ValueTask WriteAsync(bool value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)(value ? 1 : 0);
            return OutStream.WriteAsync(_buffer.AsMemory( 0, 1), cancellationToken);
        }

        // Writes a byte to this stream. The current position of the stream is
        // advanced by one.
        // 
        public virtual ValueTask WriteAsync(byte value, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // is advanced by one.
        // 
        public virtual ValueTask WriteAsync(sbyte value, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // 
        public virtual ValueTask WriteAsync(byte[] buffer, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (buffer == null)
                throw new ArgumentNullException("buffer");
            Contract.EndContractBlock();
            return OutStream.WriteAsync(buffer.AsMemory(0, buffer.Length), cancellationToken);
        }
        ...
        // method to write the byte array.
        // 
        public virtual ValueTask WriteAsync(byte[] buffer, int index, int count, CancellationToken cancellationToken = default(CancellationToken))
        {
            return OutStream.WriteAsync(buffer.AsMemory(index, count), cancellationToken);
        }
        ...
        // 
        public unsafe virtual ValueTask WriteAsync(char ch, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return OutStream.WriteAsync(_buffer.AsMemory(0, numBytes), cancellationToken);
        }
        ...
        // 
        public virtual ValueTask WriteAsync(char[] chars, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (chars == null)
            ...
            return OutStream.WriteAsync(bytes.AsMemory(0, bytes.Length), cancellationToken);
        }
        ...
        // method to write the character array.
        // 
        public virtual ValueTask WriteAsync(char[] chars, int index, int count, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        public unsafe virtual ValueTask WriteAsync(double value, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return OutStream.WriteAsync(_buffer.AsMemory(0, 8), cancellationToken);
        }

        public virtual ValueTask WriteAsync(decimal value, CancellationToken cancellationToken = default(CancellationToken))
        {
            GetBytes(value, _buffer);
            return OutStream.WriteAsync(_buffer.AsMemory(0, 16), cancellationToken);
        }
        ...
        // 
        public virtual ValueTask WriteAsync(short value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            return OutStream.WriteAsync(_buffer.AsMemory(0, 2), cancellationToken);
        }

        // Writes a two-byte unsigned integer to this stream. The current position
        // of the stream is advanced by two.
        // 
        public virtual ValueTask WriteAsync(ushort value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            return OutStream.WriteAsync(_buffer.AsMemory(0, 2), cancellationToken);
        ...
        // 
        public virtual ValueTask WriteAsync(int value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
            _buffer[3] = (byte)(value >> 24);
            return OutStream.WriteAsync(_buffer.AsMemory(0, 4), cancellationToken);
        }

        // Writes a four-byte unsigned integer to this stream. The current position
        // of the stream is advanced by four.
        // 
        public virtual ValueTask WriteAsync(uint value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        public virtual ValueTask WriteAsync(long value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        public virtual ValueTask WriteAsync(ulong value, CancellationToken cancellationToken = default(CancellationToken))
        {
            _buffer[0] = (byte)value;
            _buffer[1] = (byte)(value >> 8);
            _buffer[2] = (byte)(value >> 16);
        ...
        // 
        [System.Security.SecuritySafeCritical]  // auto-generated
        public unsafe virtual ValueTask WriteAsync(float value, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        // 
        //[System.Security.SecuritySafeCritical]  // auto-generated
        public virtual async ValueTask WriteAsync(String value, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (value == null)
        ...
        protected async ValueTask Write7BitEncodedIntAsync(int value, CancellationToken cancellationToken)
        {
